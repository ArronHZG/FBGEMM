...
public:
 ...
 auto get_num_shards() const { return shards_.size(); }
 ...
 void save(const std::string& filename) const {
   ...
   const std::size_t num_shards = get_num_shards();
 ...
 void load(const std::string& filename) {
   ...
   for (std::size_t shard_id = 0; shard_id < get_num_shards(); ++shard_id) {
